// export const writeUserData = 'https://khumla-production-user-write.azurewebsites.net';

// export const readUserData = 'https://khumla-production-user-read.azurewebsites.net';
